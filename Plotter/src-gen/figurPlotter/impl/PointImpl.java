 ...
 * </p>
 * <ul>
 *   <li>{@link figurPlotter.impl.PointImpl#getXPos <em>XPos</em>}</li>
 *   <li>{@link figurPlotter.impl.PointImpl#getYPos <em>YPos</em>}</li>
 * </ul>
 *
 * @generated
 */
public class PointImpl extends MinimalEObjectImpl.Container implements Point {
	...
	protected EClass eStaticClass() {
		return FigurPlotterPackage.Literals.POINT;
	}
	...
	public void setXPos(double newXPos) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FigurPlotterPackage.POINT__XPOS, oldXPos, xPos));
	}
	...
	public void setYPos(double newYPos) {
		...
		yPos = newYPos;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FigurPlotterPackage.POINT__YPOS, oldYPos, yPos));
	}
