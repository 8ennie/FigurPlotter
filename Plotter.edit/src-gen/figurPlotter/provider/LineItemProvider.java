...
/**
 * This is the item provider adapter for a {@link figurPlotter.Line} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class LineItemProvider extends FigurItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Line_lenght_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Line_lenght_feature", "_UI_Line_type"),
				 FigurPlotterPackage.Literals.LINE__LENGHT,
				 true,
				 false,
				 false,
