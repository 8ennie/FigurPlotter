...
/**
 * This is the item provider adapter for a {@link figurPlotter.Square} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class SquareItemProvider extends FigurItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Square_sizeA_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Square_sizeA_feature", "_UI_Square_type"),
				 FigurPlotterPackage.Literals.SQUARE__SIZE_A,
				 true,
				 false,
				 false,
