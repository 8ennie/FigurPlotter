...
/**
 * This is the item provider adapter for a {@link figurPlotter.Point} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class PointItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Point_xPos_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Point_xPos_feature", "_UI_Point_type"),
				 FigurPlotterPackage.Literals.POINT__XPOS,
				 true,
				 false,
				 false,
	...
	protected void addYPosPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Point_yPos_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Point_yPos_feature", "_UI_Point_type"),
				 FigurPlotterPackage.Literals.POINT__YPOS,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.REAL_VALUE_IMAGE,
	...
	public String getText(Object object) {
		...
		return getString("_UI_Point_type") + " " + point.getXPos();
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Point.class)) {
			case FigurPlotterPackage.POINT__XPOS:
			case FigurPlotterPackage.POINT__YPOS:
